...
<div class="p-3"><h6 class="mb-3 _2c1lVVXCA5xmsDOxsZ0_k9">
      문제 설명
    </h6> <div class="challenge-markdown"><div class="markdown solarized-dark"><p>1부터 n까지의 숫자가 시계방향으로 붙은 스택 n개가 각자의 bottom을 서로 공유하는 자료구조를 만들려 합니다. 이 때, 모든 스택이 서로 공유하는 가장 안쪽 공간을 "중앙 공간"이라고 합니다. 예를 들어, 다음 그림은 5개의 스택이 중앙을 공유하는 모습을 나타낸 것입니다.</p>
